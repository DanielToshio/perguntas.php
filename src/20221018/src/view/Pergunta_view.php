...
$icons = array("create" => "Editor", "remove_red_eye" => "Somente Leitura", "clear" => "Não Respondida", "supervisor_account" => "Professor", "person" => "Aluno", "verified_user" => "Administrador", "done"=> "Respondida", );
